...
function FileDelete(fileName) {
    return __awaiter(this, void 0, void 0, function () {
        var uploadDir, filePath, error_1, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                    if (!fileName) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "File name is required" }, { status: 400 })];
                    }
                ...
                case 3:
                    error_1 = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ error: "File not found" }, { status: 404 })];
                case 4: 
